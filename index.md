...
![Monolithic Frontends](./ressources/diagrams/Organizational/monolith-frontback-microservices.png)


__Organization in Verticals__
![End-To-End Teams with Micro Frontends](./ressources/diagrams/Organizational/verticals-headline.png)
...
## Author
**Brian Carter** ([@chipsofttech](https://twitter.com/chipsofttech)) is the Chief Research Officer at [Chippewa Software Technology](https://www.chipsofttech.com/) and works on building micro-apps.

This site is generated by Github Pages. Its source can be found at [chipsofttech/](https://github.com/chipsofttech/chipsofttech.github.io/).
